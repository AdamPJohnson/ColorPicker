...
CREATE TABLE colors (
  ...
  CONSTRAINT unique_color UNIQUE (name, hex)
);
CREATE TABLE associations (
  id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  word_id INT NOT NULL,
  color_id INT NOT NULL,
  CONSTRAINT unique_association UNIQUE (word_id, color_id)
);
CREATE INDEX word_id_index ON associations (word_id);
CREATE INDEX color_id_index ON associations (color_id);
